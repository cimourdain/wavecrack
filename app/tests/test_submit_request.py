...
from app.tests.mocks.crack_mock import crack_run_mock
...
class TestSubmitNewRequestForm(object):
    ...
    def test_submit_valid_form(self, client):
        with patch.object(Crack, 'run', new=crack_run_mock):
    ...
    def test_remove_output_directories(self, client):
        FilesHelper.delete_directory(app.config["DIR_LOCATIONS"]["hashcat_outputs"])
